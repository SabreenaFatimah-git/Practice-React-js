  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        {/* passing data dynamically to the components using props i.e passing props to the components*/}
        {/* passing props to the function component -
        <RestaurantCard resName="Chinese Bowl" Cuisine="Chinese,Asian,Thai" rating="4.4" eta="38 mins" imgrs="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/7bffceb6d709b08403c8725c689b6221"/> */}

        {/* here below we r writing reusable components,so we were able to pass in dynamic props*/}
